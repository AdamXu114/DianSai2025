...
#define CH3_LOWER_LIMIT	1100U
#define CH3_UPPER_LIMIT	1900U
#define CH4_LOWER_LIMIT	1100U
#define CH4_UPPER_LIMIT	1900U
// adjust the limit value as needed
#define MOTOR_DC_LIMIT	60

// pulse_width: value in unit of microsecond
