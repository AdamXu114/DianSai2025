#ifndef _HSP_MMA8451_H
#define _HSP_MMA8451_H

#include "gd32f4xx.h"
#include "hsp_gpio.h"
#include "hsp_i2c.h"

#define MMA8451_I2C_BASEADDR	I2C1
#define MMA8451_I2C_SPEED		400000U
#define MMA8451_I2C_ADDR7		0x38
#define MMA8451_I2C_FLAG_TIMEOUT	20000U
#define MMA8451_I2C_WRITE_ADDRESS	0x38
#define MMA8451_I2C_READ_ADDRESS	0x39
//#define CAT9555_I2C_DATASIZE	2

//MSB��ʽ��:SA0=0;Write add 0x38,read add 0x39
//LSB��ʽ��:SA0=1;Write add 0x3a,read add 0x3b
...
#define MPU6050_RA_ACC_OUT      0x3B

void hsp_mma8451_config();
void hsp_i2c_mma8451_init(void);
void hsp_mma8451_active();
void hsp_mma8451_standby();
uint8_t hsp_mma8451_read_byte(uint8_t reg, uint8_t *data);
uint8_t hsp_mma8451_read_nbyte(uint8_t reg, uint8_t *data, uint8_t num);
